...
import FundType from '@/components/pafr23visualise/fundtype';
      ...
      <Layout>
        <div className='flex flex-col pb-2 dark:text-white'>
          ...
          <div className='container mx-0 px-2 pb-3 pt-5 dark:text-gray-100  sm:px-4 lg:mx-auto lg:max-w-7xl'>
            ...
            <br />
            <h2>About Revenue Forecast Report for Fiscal Years 2023-2024</h2>
            <p className='mt-2  lg:max-w-5xl'>
              ...
              />
              Each year, in accordance with City Charter Section 311(c), the
              Controller’s Office submits a revenue report that includes
              information gathered from City departments, recent regional
              economic reports and meetings with local economists. The Revenue
              Forecast Report covers updated revenue estimates for the remainder
              of the current fiscal year — ending June 30, 2022 — and
              projections for fiscal year 2023. Although forecasts inherently
              involve uncertainty, this report offers estimates based on the
              available information and seeks to promote responsible budgeting
              in the year ahead. Also included in the report are the estimated
              requirements for debt service and General Fund cash flow
              borrowing. Use the dashboard below to explore actual receipts for
              last year, FY 21, projected revenues and their sources for FY 22
              and 23, and compare last year’s revenues to the estimates for this
              and next fiscal year.
              <br />
              While the economy is continuing to recover from the ongoing public
              health crisis, my office is cautiously optimistic that the direct
              economic impacts of the pandemic — business closures, event
              cancellations and travel restrictions — will be largely absent in
              FY 23. Although it is possible that anti-inflation actions by the
              Federal Reserve could influence revenues to some degree, any
              economic slowdown would likely impact FY 24 revenues more than FY
              23. General Fund receipts for FY 23 are projected to be $7.09
              billion, which is 6.1% less than the current year estimates and
              5.6% under the budgeted amount. This drop will be attributable to
              the loss of one-time American Rescue Plan Act (ARPA) funds, which
              will all be received by the City this year, FY 22. However,
              adjusting for this inevitability, General Fund revenue growth will
              be approximately 3.9%. This chart breaks down total City revenues
              in all categories (General Fund and special funds) from 2011 to
              2021, along with revenue projections for this fiscal year and the
              next. Filter by category or by name of revenue source.
            </p>
          </div>
          ...
          <div className='container mx-0 px-4 pb-3 pt-3  dark:text-gray-100 lg:mx-auto lg:max-w-7xl'>
            <h3 className='mt-3'>FY 23 Total Revenues: $120 billion</h3>
            {/* Add Visual - City Revenues */}
            <FundType />

            {/* <h3 className='mt-3'>FY 23 Total Expenses: $X billion</h3>
            <FundType /> */}
          </div>
