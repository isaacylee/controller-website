        ...
        <div className='flex flex-col pb-2 dark:text-white'>
          ...
          <div className='container mx-0 px-2 pb-3 pt-5 dark:text-gray-100  sm:px-4 lg:mx-auto lg:max-w-7xl'>
            ...
            <div className='lg:max-w-5xl'>
              ...
              <p>
                ...
                resulted in XXX last year and a projected XXX in the current
                year.
                <br />
                <br />
                General Fund budgeted revenues last year also turned out to be
                overly optimistic. In March, our Office projected $XXX in
                General Fund revenues, while the Budget adopted by the Council
                and signed by the Mayor assumed $XXX. Actual revenues turned out
                to be $XXX.
                <br />
                The 3.0% increase over FY 23 in General Fund revenues falls
                ...
                <ul>
                  ...
                  <li>
                    ...
                    in Documentary Transfer Tax revenue ($49 million), the
                ...
                14.0% increase over FY 23, primarily due to the following:
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    in her Executive Directive No. 9 which lays out a
                  ...
                  <br></br>
                  <li>
                    The reforms she outlines in ED 9 reflect the same strategic
          ...
          <div className='container mx-0 px-4 pb-3 pt-3  dark:text-gray-100 lg:mx-auto lg:max-w-7xl'>
            ...
            <h3>
              ...
              <b>
                {' '}
                Net Position: $31.7 billion, $1.1 billion, 3.6% increase from FY
                23
              </b>
            </h3>
            ...
            <div className='lg:max-w-5xl'>
              <p>
                ...
                of $1.6 billion over FY 23. The City uses these assets to
                ...
                legislation. This is an increase of $284.8 million over FY 23.
              ...
              <span className='font-bold  '>
                <b>In FY 24,</b> General Fund revenues was{' '}
                <b>
                  {' '}
                  $6.9 billion, $200.7 million (3.0%) increase over FY 23, and
              ...
              <ul className='list-disc'>
                <li>
                  ...
                  receipts of $110.7 million, a combined increase of $38.5
                  million from vehicle license fees replacement and Ex-Community
                  Redevelopment Agency tax increment receipts, and offset by a
                ...
                <li>
                  ...
                  of $52.0 million in gas users tax receipts, after a return of
                  previously high natural gas prices to normal levels. This is
                ...
                <li>
                  ...
                  <li>
                    ...
                    and other revenues increased by $114.2 million. Increase in
            ...
            <div className='lg:max-w-5xl'>
              <h4 className='font-bold'>
                In FY 24 General Fund Expenditures was $6.8 billion, $840.7
                million (14.0%) increase over FY 23, primarily due to the
                following:
              </h4>
              {/*Expenses  vis */}
              ...
              <ul className='list-disc'>
                <li>
                  ...
                  and overtime for fire life safety inspections.
                </li>
                <li>
                ...
                <li>
                  ...
                  $138.8 million, or 12.6%. This rise is primarily attributed to
            ...
            <div className='container mx-0 px-4 pb-3 pt-3  dark:text-gray-100 lg:mx-auto lg:max-w-7xl'>
              ...
              <h4>
                ...
                increase of $180.8 million or 0.5% from FY 23
              </h4>
              <div className='lg:max-w-5xl'>
              ...
              <span>
                ...
                available liquidity. Additionally, Moody's Ratings revised the
