  ...
  return (
    <div style={{ color: 'white' }}>
      ...
      <center>
        ...
        >
          ...
          <p className='mb-4'>
            ...
            expenditures, reserves and bonded indebtedness. In January 2024, the
            Controller’s Office will follow up by issuing the Annual
          ...
          <p className='mb-4'>
            Accompanying this report are online interactive visualizations with
            10 years of data, which may be found at
            https://controller.lacity.gov/reports/pfr23. Information on special
            fund balances and uses, historic Reserve Fund balances, and other
            budgetary information may also be found on my website.
            <br></br>
            <br></br>
          ...
          <p className='mb-4'>
            ...
            actual expenditures increased by 6.6% over the previous fiscal year
            and exceeded the adopted budget by nearly $200 million or 4.1%. This
            was offset by savings of $120 million in the Unappropriated Balance
            and $155 million in General City Purposes spending. The combination
            of higher than anticipated revenues and lower than expected total
            expenses saw the City’s General Fund begin this fiscal year with
            General Fund reserves (Reserve Fund, Budget Stabilization Fund and
            Unappropriated Balance line item set aside for mid-year adjustments)
            at a record-high $876.3 million or 11.1% of the General Fund,
            exceeding the City’s goal of 10% reserves
            <br></br>
          ...
          <p className='mb-4'>
            ...
            and Fines ($40.8 million below); Parking Fines ($21.million below);
            and Grant Receipts ($15.6 million below).
            <br></br>
            <br></br>● While staff vacancies resulted in $118 million in savings
            among civilian employees, Police and Fire salaries were $29 million
            over their budgeted amount. The overspending was attributed to
            ...
            nearly 100%.
            <br></br>
            <br></br>● The City’s debt ratio remains well below the limits under
            City policy, providing the potential for expanded capital investment
            if revenue flows can support new borrowing.
            <br></br>
          ...
          <p className='mb-4'>
            ...
            million, meaning that rebuilding the City’s workforce will make it
            more difficult to balance the General Fund budget in the future.
            <br></br>
            <br></br>● Major contributors to the strong revenue increase include
            Utility Users Tax revenue ($93 million above budget) primarily from
            higher natural gas and electric prices; franchise income ($53.7
            ...
            years, with the likelihood of commensurate increases in compensation
            for police management and the larger civilian workforce. All by
            themselves, these adjustments tilt future budgets into structural
            deficits.
            <br></br>
            <br></br>● As our Office has consistently pointed out, pension debt
            and citywide deferred maintenance of vital infrastructure require
            urgent attention. Last year’s underspending of $316 million in
            budgeted capital expenditures underscores that the City continues to
            fall behind – which means even higher costs in the long run.
            <br></br>
          ...
          <p className='mb-4'>
            ...
            transition to a two-year cycle would save enormous staff time, give
            greater opportunity for meaningful community participation and allow
            for a more strategic approach to the City’s Finances. The City also
            needs a transparent Capital Improvement Program beyond the current
            wish list of billions of dollars in unfunded projects. Participatory
          ...
          <p className='mb-4'>
            ...
            undertake a strategic reallocation of resources to what matters most
            to the long-term wellbeing of all of our residents. Budgets are not
          ...
          <p className='mb-4'>
            ...
            additional information, please contact my Director of Financial
      ...
      <p className='mb-4'>
        ...
        billion, a decrease of 1.1 percent over the prior year, and 4.8 percent
        under the Budget
        <br></br>
        View this interactive data visualization to explore the relative size of
        the City’s revenue sources and their growth over the past 10 years.
      </p>
      <Revenue />
      <br></br>
      <br></br>
      ...
      <p className='mb-4'>
        ...
        million or 6.5% percent higher than the year prior as spending increased
        across nearly every category.
        <br></br>
        This interactive data visualization compares the expenditures of the
        City’s different departments, as well as non-departmental expenditures,
      ...
      <p className='mb-4'>
        ...
        The City’s Reserve Fund Policy sets a goal for the Reserve Fund to be at
        least 5% of the General Fund budget every year. On July 1, 2023, the
        Reserve Fund had a balance of $648.3 million, 8.2% of the General Fund
        budget and well above the 5% Reserve Fund Policy goal.
      </p>
      <br></br>
      <p className='mb-4'>
        The Budget Stabilization Fund (BSF) was added to the City Charter in
        2011. The purpose of the BSF is to set aside funds when the City exceeds
        revenue projections to help smooth out years when revenue is stagnant or
        in decline. In fiscal year 2023, the BSF grew slightly to $195.8
        million.
      </p>
      <p className='mb-4'>
      ...
      <p className='mb-4'>
        ...
        total debt service cap of 15% as a percent of General Fund revenues. The
        City’s debt service obligations decreased to 3.9% last fiscal year.
      </p>
      <Debt />
    </div>
  );
