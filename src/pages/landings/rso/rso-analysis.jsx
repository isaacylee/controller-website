      ...
      title: {
        ...
        color: textColor,
          ...
          <div className="w-full mb-8">
            ...
            >
              <p className="mb-4">
                Properties with <strong>2 units</strong> had the highest net increase in RSO units with <strong>6,680 units</strong> followed by properties with <strong>1 unit</strong> with an additional <strong>1,751</strong> RSO units.
                <br></br>
                <br></br>
