        ...
        >
          ...
          >
            ...
            <p className='mb-4'>
              ...
              which prohibits cities from enforcing anti-camping laws if they do
              not have enough shelter beds for unhoused residents. Following the
              2018 <span style={{ fontStyle: 'italic' }}>Martin v. Boise</span>{' '}
              ruling and prior to the City’s 2021 amendment, enforcement of
              41.18 was unconstitutional under the Eighth Amendment’s
              prohibition on cruel and unusual punishment. The constitutionality
              of the current version of 41.18 is still disputed.
            </p>

            <p className='mb-4'>
              This map and analysis display 41.18 arrest data obtained from the
              Los Angeles Police Department beginning on January 1, 2021
          ...
          >
            <p className='mb-4'>
              From January 1, 2021 to September 15, 2023, there were 3,548 41.18
