...
<center>
<div className="image-container">
  <img src="/images/arrests/lapdarrests-types2019.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2019. There are 15 Council Districts. Council District 14 has a much higher number of arrests than any other district, with around 14,000 arrests. There are several other Council Districts with around 7,000 to 9,000 arrests (CDs 1, 6, 8, 9, 13), The rest of the Council Districts have fewer than around 5,000 to 6,000 arrests. CDs 5 and 12 in particular have the fewest number of arrests, at around 2,500 arrests each. Source of data is LAPD." />
  <img src="/images/arrests/lapdarrests-types2020.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2020. There are fewer arrests overall compared to 2019. There are 15 Council Districts. Council District 14 has the highest number of arrests, at around 7,500 arrests,  but is also fairly close in number of arrests to districts 8 and 9, which are around 6,000 arrests.  CDs 1, 6, 10, 11, and 13 each have around 5,000 arrests. The rest of the Council Districts have much fewer than 5,000  arrests. CDs 5 and 12 have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD." />

</div>

<div className="image-container">
<img src="/images/arrests/lapdarrests-types2021.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2021. There are still fewer arrests overall compared to 2019. There are 15 Council Districts. Council Districts  8 and 14 have the highest number of arrests, at around 6,000  arrests,  and are also fairly close in number of arrests to districts 9, and 11 which are also close to 6,000 arrests.  CDs 1, 6, and 13 each have around 5,000 arrests. The rest of the Council Districts havemuch fewer than 5,000  arrests. CDs 5 and 12 again have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD." />
  <img src="/images/arrests/lapdarrests-types2022.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2022. There are still fewer arrests overall compared to 2019. There are 15 Council Districts. Council Districts 14, 8, and 1 have the highest number of arrests, at around 5,000 to 6,000  arrests,  and are also fairly close in number of arrests to districts 6, 9,  11, and 13 which are also close to 5,000 arrests. The rest of the Council Districts havemuch fewer than 5,000  arrests. CDs 4 and 5 have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD. " />
</div>
{/* <div className="image-container">
...
<div className="image-container mobile-left-align" style={{ display: "flex", alignItems: "center" }}>
  ...
  <div style={{ flex: "1" }}>
    <p className="dark:text-white mobile-left-align" style={{ fontFamily: "Helvetica" }}>
    Este mapa demuestra ubicaciones y detalles de más de 300,000 arrestos que el
     Departamento de Policía de Los Ángeles hizo entre 2019 y 2022. Usuarios pueden navegar 
     el mapa y filtrar por raza, Distrito del Consejo, División de LAPD, y tipo de arrestos.
      <br />
      <br />
      La información fue obtenida del Departamento de Policía de Los Ángeles, pero marca 
...
<center> 
<div>
  <h3 className='dark:text-white mobile-left-align' style={{ fontFamily: "Helvetica" }}><b>Arrestos por Raza</b></h3>
</div>
</center>
<div className="image-container">
  <img src="/images/arrests/spanish/Sp-lapdarrests-race.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Race, 2019-2022. The tallest bar is Hispanic/Latino, at 51%. Next is Black, at 27%, then White at 16%, then Other at 5%. Total arrests for each of the following 4 race categories are not more than 0%: Asian, Pacific Islander, Unknown, and American Indian/Alaskan Native. The Source of Data is LAPD." />
  <img src="/images/arrests/spanish/Sp-lapopulation.png" width="400" height="600" alt="A bar chart of Los Angeles Population by Race.  Hispanic/Latino is 48%.  Black is 8%. White is 29%. Other is 0%.  Asian is 12%, Pacific Islander is 0%, 2+ races is 3%, and American Indian/Alaskan Native is 0%. Source of Data is American Community Survey, 2021 5-Year Estimate." />
</div>
...
<div>
    ...
    <span className='dark:text-white mobile-left-align' style={{ fontFamily: "Helvetica" }}>
      <p className='mobile-left-align'>Como el mapa refleja, gente morena y negra o afrodescendiente son arrestados en una <br></br>
      tasa desproporcionada, componiendo un promedio de 78.26% de todos <br></br>los arrestos en los últimos cuatro años (2019-2022), 
    ...
    <ul className='mobile-left-align'>
      {/* <li>Brown and Black people are arrested at a disproportionate rate relative to the overall population  </li> */}
      <br></br>
      <li>Gente morena y negra o afrodescendiente = 78.26% arrestos de 2019-2022</li>
     
      <li>Gente morena y negra o afrodescendiente = 56% de la población de la ciudad de Los Ángeles (según datos del Censo de 2020)</li>
      </ul> 
</span>

<div className="image-container">
  <img src="/images/arrests/spanish/Sp-lapdarrests-race-2019.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2019. There are 15 Council Districts. Council District 14 has a much higher number of arrests than any other district, with around 14,000 arrests. There are several other Council Districts with around 7,000 to 9,000 arrests (CDs 1, 6, 8, 9, 13), The rest of the Council Districts have fewer than around 5,000 to 6,000 arrests. CDs 5 and 12 in particular have the fewest number of arrests, at around 2,500 arrests each. Source of data is LAPD." />
  <img src="/images/arrests/spanish/Sp-lapdarrests-race-2020.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2020. There are fewer arrests overall compared to 2019. There are 15 Council Districts. Council District 14 has the highest number of arrests, at around 7,500 arrests,  but is also fairly close in number of arrests to districts 8 and 9, which are around 6,000 arrests.  CDs 1, 6, 10, 11, and 13 each have around 5,000 arrests. The rest of the Council Districts have much fewer than 5,000  arrests. CDs 5 and 12 have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD." />

</div>

<div className="image-container">
<img src="/images/arrests/spanish/Sp-lapdarrests-race-2021.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2021. There are still fewer arrests overall compared to 2019. There are 15 Council Districts. Council Districts  8 and 14 have the highest number of arrests, at around 6,000  arrests,  and are also fairly close in number of arrests to districts 9, and 11 which are also close to 6,000 arrests.  CDs 1, 6, and 13 each have around 5,000 arrests. The rest of the Council Districts havemuch fewer than 5,000  arrests. CDs 5 and 12 again have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD." />
  <img src="/images/arrests/spanish/Sp-lapdarrests-race-2022.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2022. There are still fewer arrests overall compared to 2019. There are 15 Council Districts. Council Districts 14, 8, and 1 have the highest number of arrests, at around 5,000 to 6,000  arrests,  and are also fairly close in number of arrests to districts 6, 9,  11, and 13 which are also close to 5,000 arrests. The rest of the Council Districts havemuch fewer than 5,000  arrests. CDs 4 and 5 have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD. " />
</div>
...
<center> 
<div>
  <h3 className='dark:text-white mobile-left-align' style={{ fontFamily: "Helvetica" }}><b>Arrestos por Distrito del Consejo
</b></h3>
</div>
</center>
<div className="image-container">
  <img src="/images/arrests/spanish/Sp-lapdarrestsCD-2019.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2019. There are 15 Council Districts. Council District 14 has a much higher number of arrests than any other district, with around 14,000 arrests. There are several other Council Districts with around 7,000 to 9,000 arrests (CDs 1, 6, 8, 9, 13), The rest of the Council Districts have fewer than around 5,000 to 6,000 arrests. CDs 5 and 12 in particular have the fewest number of arrests, at around 2,500 arrests each. Source of data is LAPD." />
  <img src="/images/arrests/spanish/Sp-lapdarrestsCD-2020.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2020. There are fewer arrests overall compared to 2019. There are 15 Council Districts. Council District 14 has the highest number of arrests, at around 7,500 arrests,  but is also fairly close in number of arrests to districts 8 and 9, which are around 6,000 arrests.  CDs 1, 6, 10, 11, and 13 each have around 5,000 arrests. The rest of the Council Districts have much fewer than 5,000  arrests. CDs 5 and 12 have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD." />

</div>

<div className="image-container">
<img src="/images/arrests/spanish/Sp-lapdarrestsCD-2021.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2021. There are still fewer arrests overall compared to 2019. There are 15 Council Districts. Council Districts  8 and 14 have the highest number of arrests, at around 6,000  arrests,  and are also fairly close in number of arrests to districts 9, and 11 which are also close to 6,000 arrests.  CDs 1, 6, and 13 each have around 5,000 arrests. The rest of the Council Districts havemuch fewer than 5,000  arrests. CDs 5 and 12 again have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD." />
  <img src="/images/arrests/spanish/Sp-lapdarrestsCD-2022.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2022. There are still fewer arrests overall compared to 2019. There are 15 Council Districts. Council Districts 14, 8, and 1 have the highest number of arrests, at around 5,000 to 6,000  arrests,  and are also fairly close in number of arrests to districts 6, 9,  11, and 13 which are also close to 5,000 arrests. The rest of the Council Districts havemuch fewer than 5,000  arrests. CDs 4 and 5 have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD. " />
</div>
<br />
<center> 
<div className='mobile-left-align'>
...
<center> 
<div>
  <h3 className='dark:text-white mobile-left-align' style={{ fontFamily: "Helvetica" }}><b>Tipo de Arresto</b></h3>
</div>
</center>
<center>
<div className="image-container">
  <img src="/images/arrests/spanish/Sp-lapdarrests-type2019.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2019. There are 15 Council Districts. Council District 14 has a much higher number of arrests than any other district, with around 14,000 arrests. There are several other Council Districts with around 7,000 to 9,000 arrests (CDs 1, 6, 8, 9, 13), The rest of the Council Districts have fewer than around 5,000 to 6,000 arrests. CDs 5 and 12 in particular have the fewest number of arrests, at around 2,500 arrests each. Source of data is LAPD." />
  <img src="/images/arrests/spanish/Sp-lapdarrests-type2020.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2020. There are fewer arrests overall compared to 2019. There are 15 Council Districts. Council District 14 has the highest number of arrests, at around 7,500 arrests,  but is also fairly close in number of arrests to districts 8 and 9, which are around 6,000 arrests.  CDs 1, 6, 10, 11, and 13 each have around 5,000 arrests. The rest of the Council Districts have much fewer than 5,000  arrests. CDs 5 and 12 have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD." />

</div>

<div className="image-container">
<img src="/images/arrests/spanish/Sp-lapdarrests-type2021.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2021. There are still fewer arrests overall compared to 2019. There are 15 Council Districts. Council Districts  8 and 14 have the highest number of arrests, at around 6,000  arrests,  and are also fairly close in number of arrests to districts 9, and 11 which are also close to 6,000 arrests.  CDs 1, 6, and 13 each have around 5,000 arrests. The rest of the Council Districts havemuch fewer than 5,000  arrests. CDs 5 and 12 again have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD." />
  <img src="/images/arrests/spanish/Sp-lapdarrests-type2022.png" width="400" height="600" alt="A bar chart of LAPD Arrests by Council District, 2022. There are still fewer arrests overall compared to 2019. There are 15 Council Districts. Council Districts 14, 8, and 1 have the highest number of arrests, at around 5,000 to 6,000  arrests,  and are also fairly close in number of arrests to districts 6, 9,  11, and 13 which are also close to 5,000 arrests. The rest of the Council Districts havemuch fewer than 5,000  arrests. CDs 4 and 5 have the fewest number of arrests, at under 2,500 arrests each. Source of data is LAPD. " />
</div>
{/* <div className="image-container">
<img src="/images/arrests/lapdarrests-type2019.png" width="400" height="600" alt="A donut chart of LAPD Arrests by Type, 2019. There are 2 categories: There’s Felony, and there’s Misdemeanor & Infraction. The bigger category is Misdemeanor & Infraction at 55,954, or 62.4%. Felony is 33,663, or 37.6%. Source of Data is LAPD. " />
  <img src="/images/arrests/lapdarrests-type2020.png" width="400" height="600" alt="A donut chart of LAPD Arrests by Type, 2020. There are 2 categories: There’s Felony, and there’s Misdemeanor & Infraction. The slightly bigger category is Misdemeanor & Infraction at 34,659, or 52.8%. Felony is 31,015, or 47.2%. Source of Data is LAPD. " />
...
<div className='mobile-left-align'>
    ...
    <span className='dark:text-white' style={{ fontFamily: "Helvetica" }}>
    Los tipos de arresto de LAPD se dividen en cinco categorías identificadas por LAPD:  <br></br>(1) delito grave,   (2) delito menor, 
    (3) infracciones, (4) dependiente y (5) otros.
...
<div>
    ...
    <span className='dark:text-white mobile-left-align' style={{ fontFamily: "Helvetica" }}>
      <p className='mobile-left-align'>Según la ley de California, un delito grave es un delito que puede ser castigado con la 
      muerte, con encarcelamiento en una prisión estatal o por encarcelamiento en  <br></br>una cárcel del condado bajo [ciertas disposiciones]. Cualquier otro delito y ofensa 
      pública es un delito menos grave,  <br></br>excepto aquellos delitos que se clasifican como infracciones. 
      Los delitos menores y las infracciones conllevan diversos grados de consecuencias financieras y de encarcelamiento.
...
<div>
    ...
    <ul className='mobile-left-align'>
      <li className='mobile-left-align'>2019: 55,954 arrestos por delitos menores e infracciones frente a 33,663 arrestos por delitos graves </li>
      <li className='mobile-left-align'>2020: 34,659 arrestos por delitos menores e infracciones frente a 31,015 arrestos por delitos graves</li>
      <li className='mobile-left-align'>2021: 33,179 arrestos por delitos menores e infracciones frente a 32 597 arrestos por delitos graves</li>
      <li className='mobile-left-align'>2022: 30,431 arrestos por delitos menores e infracciones frente a 30 378 arrestos por delitos graves</li>
      </ul> 
      <br></br>
      <div>
  <h3 className='dark:text-white mobile-left-align' style={{ fontFamily: "Helvetica" }}><b>Arrestos de dependientes</b></h3>
</div>
      <p className='dark:text-white mobile-left-align' style={{fontFamily: "Helvetica"}}> <br></br>
...
<p className='dark:text-white mobile-left-align' style={{fontFamily: "Helvetica"}}> <br></br>
Los datos disponibles no son claros sobre la naturaleza de estas interacciones, pero plantean dudas sobre <br></br>
...
<br></br>
<ul className='mobile-left-align'>
      <li className='mobile-left-align'>2019: 464 arrestos de dependientes</li>
      <li className='mobile-left-align'>2020: 429 arrestos de dependientes</li>
      <li className='mobile-left-align'>2021: 422 arrestos de dependientes</li>
      <li className='mobile-left-align'>2022: 545 arrestos de dependientes</li>
      </ul> 
