...
<br></br>Honorable Members of the Los Angeles City Council
            ...
            To better empower both the general public and policy makers to understand what we are receiving in return for our
             investment, my Office conducted its <b><i>first-ever audit</i></b> of the Los Angeles Police Department’s (LAPD) 
             ...
             members and organizations who requested more information regarding the costs and performance of LAPD helicopters.
              Our audit focused on the LAPD’s use of helicopters from fiscal years (FYs) 2018 through 2022 and explored whether
               the LAPD has justified the need for the program’s current size and scope, which consists of 17 helicopters and 
               more than 90 employees. 
{' '}
            </p>
            <p className='mb-5 text-left dark:text-white'>
            Despite spending an average of $46.6 million every year on the ASD, there is limited external oversight or 
            monitoring of the ASD, its policies, practices, or whether the program which was established in the 1970s is in 
            line with the City’s present-day needs. Over its 67 year history, the ASD program has transitioned from 1 helicopter
             to a fleet of 17. With no comprehensive, external audit of the program until now, inefficiencies, data reliability 
             issues, and lack of transparency and performance monitoring have gone unchecked. 
{' '}
            </p>
            <p className='mb-5 text-left dark:text-white'>
            ...
            <ul className='mb-5 ml-10 text-left dark:text-white'>
              <li>
                &bull; <b>The ASD program costs nearly $50 million annually while most of the flight time is devoted to low priority events </b>
                Our audit found that the estimated annual cost to operate the helicopter program is $46.6 million (i.e., $128,000 per day or $2,900 per hour) 
                There are 14 City departments whose annual budgets do not reach this amount;

              </li>
              <li>
                &bull; 61% of flight time (i.e., 6 out of 10 flights) was dedicated to activities not associated with the highest priority incidents, such as transportation flights, general patrol time, and ceremonial flights;
            ...
            the City operates its helicopter fleet on an almost continuous basis. Typically, there are two helicopters
             flying for 20 hours every day of the year. During FY 2018-22, these helicopters logged an average of 16,000
              hours of flight time each year. 
           ...
           <b>  Our audit makes recommendations for (1) reducing inefficiencies, 
            ...
            (3) boosting transparency and performance monitoring, including but not limited to the following:  </b>
{' '}
            </p>
            <ul className='mb-5 ml-10 text-left dark:text-white'>
            <li>
